...
async function bootstrap(){
  ...
  $('#search').addEventListener('input', e=>{ state.search = e.target.value; onChange(); });
  ...
  $('#clear').addEventListener('click', ()=>{
    ...
    $('#search').value=''; $('#genre').value='Todos'; $('#price').value='Todos';
    $('#sort').value='Relevância'; $('#onlyFav').checked=false;
    onChange();
  });
